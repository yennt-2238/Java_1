...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Diem cua " + st3.getFullName() + " la: " + st3.calculateAVG());
		System.out.println("Diem cua " + st4.getFullName() + " la: " + st4.calculateAVG());
		System.out.println("Diem cua " + st5.getFullName() + " la: " + st5.calculateAVG());
		System.out.println("Diem cua " + st6.getFullName() + " la: " + st6.calculateAVG());
		System.out.println("Diem cua " + st7.getFullName() + " la: " + st7.calculateAVG());
		System.out.println("Diem cua " + st8.getFullName() + " la: " + st8.calculateAVG());
		System.out.println("Diem cua " + st9.getFullName() + " la: " + st9.calculateAVG());
